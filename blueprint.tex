...
\textbf{Автор та генеалогія.} Команда Funbox (GitHub: \texttt{@funboxteam}), репозиторій \texttt{funboxteam/blueprinter}. Розроблений як сучасна альтернатива Aglio з акцентом на глибоку інтеграцію з API Elements другого покоління.

\textbf{Технічні характеристики.} Написаний на Node.js. Встановлюється через npm як \texttt{@funboxteam/blueprinter}. Приймає \texttt{.apib}-файл та генерує самодостатній HTML-файл (\texttt{index.html}) без зовнішніх залежностей. Підтримує режим watch/live-server.
...
\midrule
K1 & \textbf{Повна підтримка MSON 2.x} & Специфікація ЕСОЗ використовує складне успадкування та вкладені елементи \\
K2 & \textbf{Мінімальна кількість попереджень/помилок} & Безпосередній метрик якості міграції \\
K3 & \textbf{Автономність від сервісів Oracle Apiary} & Ключова передумова задачі (EoL) \\
K4 & \textbf{Пошук та навігація в UX} & МІС-розробники потребують зручного доступу до специфікацій \\
K5 & \textbf{Підтримка середовища Node.js} & Відповідність поточному технологічному стеку команди \\
K6 & \textbf{Активна підтримка та оновлення} & Зниження ризику повторного EoL у середньостроковій перспективі \\
\bottomrule
\end{tabular}
\end{table}
...
\centering
\small
\caption{Порівняння інструментів}
\setlength{\tabcolsep}{4pt}
\begin{tabular}{@{}p{4.2cm}cccc@{}}
\toprule
Характеристика & Aglio & Boilerplate & Phpdraft & \textbf{Blueprinter} \\
\midrule
Мова реалізації & Node.js & Node.js/Ruby & PHP & \textbf{Node.js} \\
Початок розробки & 2014 & 2015 & 2016 & {\raise.17ex\hbox{\texttildelow}}2019 \\
...
МSON вкладеність & Часткова & Часткова & Часткова & \textbf{Повна} \\
...
\centering
\small
\caption{Оцінювання за критеріями міграції}
\begin{tabular}{@{}lcccc@{}}
\toprule
Критерій & Aglio & Boilerplate & Phpdraft & \textbf{Blueprinter} \\
\midrule
K1: Підтримка MSON 2.x & 2/5 & 2/5 & 3/5 & \textbf{5/5} \\
K2: Мінімум помилок при рендерингу & 2/5 & 1/5 & 3/5 & \textbf{4/5} \\
...
\begin{enumerate}
\item API Blueprint Specification. \url{https://apiblueprint.org/documentation/specification.html} (дата звернення: 18.03.2026).
\item danielgtaylor/aglio: Maintenance notice. GitHub Issues. \url{https://github.com/danielgtaylor/aglio/issues} (дата звернення: 18.03.2026).
\item funboxteam/blueprinter. GitHub Repository. \url{https://github.com/funboxteam/blueprinter} (дата звернення: 18.03.2026).
\item SMillerDev/phpdraft. GitHub Repository. \url{https://github.com/SMillerDev/phpdraft} (дата звернення: 18.03.2026).
\item jsynowiec/api-blueprint-boilerplate. GitHub Repository. \url{https://github.com/jsynowiec/api-blueprint-boilerplate} (дата звернення: 18.03.2026).
\item Nešetřil, J., Vrábel, Z. API Blueprint: A Web API Documentation Language. 2013. \url{https://apiblueprint.org} (дата звернення: 18.03.2026).
\item MSON (Markdown Syntax for Object Notation) Specification. \url{https://github.com/apiaryio/mson} (дата звернення: 18.03.2026).
\item eHealth Ukraine ONE-API Repository. \url{https://github.com/ehealth-ua/ONE-API} (дата звернення: 18.03.2026).
\item Oracle Apiary End-of-Life Announcement. Oracle Cloud Documentation, 2024.
\item Drafter — C++ API Blueprint Parser. \url{https://github.com/apiaryio/drafter} (дата звернення: 18.03.2026).
\end{enumerate}
